...
// Format: nameDeutsch (oben) und nameEnglish (unten)
export const alignments: Alignment[][] = [
  [
    {
      name: 'Rechtschaffen Gut',
      nameEnglish: 'Lawful Good',
